...
Error: French content visible in decisions/adr-088.html with data-lang=en:
  line 154: "é" in "GitHub Projects: the linked ticket moved to Terminé."
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e30]:
    ...
    - main [ref=e125]:
      - generic [ref=e126]:
        - generic [ref=e127]:
          - code [ref=e128]: ADR-088
          - status [ref=e130]:
            - generic [ref=e131]: Active
          - generic [ref=e132]: contract
        - heading "Agentica logo colors formalized (retroactive)" [level=1] [ref=e133]
        - generic [ref=e134]:
          - generic [ref=e135]:
            - term [ref=e136]: Date
      ...
      - paragraph [ref=e142]:
        - code [ref=e143]: scripts/validate-contracts.js
        - text: (ADR-086) flags
        - code [ref=e144]: semantic.color.brand.logo-black
        - text: and
        - code [ref=e145]: semantic.color.brand.logo-gray
        - text: as citing
        - code [ref=e146]: "\"decision\": \"logo-identity\""
        - text: — a value that doesn't match the
        - code [ref=e147]: ADR-XXX
        - text: shape every other
        - code [ref=e148]: decision
        - text: field in the token system uses.
      - paragraph [ref=e149]:
        - text: "Investigation found this wasn't a stand-in for an existing ADR:"
        - strong [ref=e150]: no ADR ever formally established the logo colors.
        - text: ADR-024 defines the brand *palette* (Teal/Rose/Bordeaux) but does not mention the logo's black (
        - code [ref=e151]: "#000000"
        - text: ) / gray (
        - code [ref=e152]: "#6B7280"
        - text: ) values at all. Per
        - code [ref=e153]: .claude/skills/pipelines/adr-triggers.md
      ...
      - paragraph [ref=e154]:
        - code [ref=e155]: tokens/primitives.json
        - text: "'s own"
        - code [ref=e156]: primitive.color.brand._readme
        ...
        - code [ref=e157]: "#000000"
        - text: and
        - code [ref=e158]: "#6B7280"
        - text: directly."* This ADR makes that existing, already-enforced intent official instead of introducing a new rule.
      - heading "Decision" [level=2] [ref=e159]
      - paragraph [ref=e160]:
        - text: "1."
        - strong [ref=e161]:
          - code [ref=e162]: primitive.color.brand.black
          - text: (
          - code [ref=e163]: "#000000"
          - text: ) and
          - code [ref=e164]: primitive.color.brand.gray
          - text: (
          - code [ref=e165]: "#6B7280"
        ...
        - code [ref=e166]: "#000000"
        - text: /
        - code [ref=e167]: "#6B7280"
        - text: value, per the existing
        - code [ref=e168]: _readme
        - text: note. 2.
        - strong [ref=e169]:
          - code [ref=e170]: semantic.color.brand.logo-black
          - text: /
          - code [ref=e171]: logo-gray
        - text: are the semantic layer over them, reserved for logo/wordmark/brand-icon use only (
        - code [ref=e172]: doNotUse
        - text: ": regular text, page background, any generic UI component — already encoded in"
        - code [ref=e173]: $extensions.doNotUse
        - text: ", unchanged by this ADR). 3."
        - strong [ref=e174]:
          - code [ref=e175]: tokens/semantic.json
          - text: "'s"
          - code [ref=e176]: decision
          - text: field for both tokens is updated from
          - code [ref=e177]: "\"logo-identity\""
          - text: to
          - code [ref=e178]: "\"ADR-088\""
        - text: ", resolving the"
        - code [ref=e179]: validate-contracts.js
      ...
      - heading "Rejected alternatives" [level=2] [ref=e181]
      - table [ref=e183]:
        - rowgroup [ref=e184]:
          - row "Alternative Reason for rejection" [ref=e185]:
            - columnheader "Alternative" [ref=e186]
            - columnheader "Reason for rejection" [ref=e187]
        - rowgroup [ref=e188]:
          - 'row "Leave \"decision\": \"logo-identity\" as a documented, permanent exception to the ADR-shaped convention Would mean this project''s own trigger matrix (\"new color → ADR required\") doesn''t actually apply to every color — better to close the real gap than carve out an exception for it" [ref=e189]':
            - 'cell "Leave \"decision\": \"logo-identity\" as a documented, permanent exception to the ADR-shaped convention" [ref=e190]':
              - text: Leave
              - code [ref=e191]: "\"decision\": \"logo-identity\""
              - text: as a documented, permanent exception to the ADR-shaped convention
            - cell "Would mean this project's own trigger matrix (\"new color → ADR required\") doesn't actually apply to every color — better to close the real gap than carve out an exception for it" [ref=e192]
          - row "Fold this into ADR-024 (amend the brand palette ADR) ADR-024 is ✅ Active and, per decisions/README.md's own rule, \"immutable once active — any modification = a new ADR\"; amending it would violate that rule" [ref=e193]:
            - cell "Fold this into ADR-024 (amend the brand palette ADR)" [ref=e194]
            - cell "ADR-024 is ✅ Active and, per decisions/README.md's own rule, \"immutable once active — any modification = a new ADR\"; amending it would violate that rule" [ref=e195]:
              - text: ADR-024 is
              - code [ref=e196]: ✅ Active
              - text: and, per
              - code [ref=e197]: decisions/README.md
              - text: "'s own rule, \"immutable once active — any modification = a new ADR\"; amending it would violate that rule"
      - heading "Consequences" [level=2] [ref=e198]
      - list [ref=e199]:
        - listitem [ref=e200]:
          - code [ref=e201]: tokens/semantic.json
          - text: ":"
          - code [ref=e202]: decision
          - text: field on both tokens now reads
          - code [ref=e203]: "\"ADR-088\""
          - text: .
        - listitem [ref=e204]:
          - code [ref=e205]: npm run validate:contracts
          - text: "(once merged with PR #46/ADR-086): the"
          - code [ref=e206]: logo-identity
          - text: warning
      - paragraph [ref=e207]:
        - text: disappears — every
        - code [ref=e208]: decision
        - text: field is now ADR-shaped and resolves to a real file.
      - list [ref=e209]:
        - listitem [ref=e210]:
          - text: No value, alias, or
          - code [ref=e211]: $extensions.doNotUse
          - text: change — this ADR documents an existing, already
      - paragraph [ref=e212]: correctly-enforced constraint, it does not alter it.
      - list [ref=e213]:
        - listitem [ref=e214]: "GitHub Projects: the linked ticket moved to Terminé."
      - generic [ref=e215]:
        - link "← ADR-087" [ref=e216] [cursor=pointer]:
          - /url: adr-087.html
        - link "ADR-089 →" [ref=e217] [cursor=pointer]:
          - /url: adr-089.html
    - navigation "Table of contents / Table des matières" [ref=e218]:
      - generic [ref=e219]: On this page
      - link "Context" [ref=e220] [cursor=pointer]:
        - /url: "#context"
      - link "Decision" [ref=e221] [cursor=pointer]:
        - /url: "#decision"
      - link "Rejected alternatives" [ref=e222] [cursor=pointer]:
        - /url: "#rejected-alternatives"
      - link "Consequences" [ref=e223] [cursor=pointer]:
        - /url: "#consequences"
