...
Error: French content visible in decisions/adr-082.html with data-lang=en:
  line 163: "é" in "The GitHub Projects "Séparer les composants Brand/logo dans un fichier Figma dédié" ticket (P2) move"
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e30]:
    ...
    - main [ref=e125]:
      - generic [ref=e126]:
        - generic [ref=e127]:
          - code [ref=e128]: ADR-082
          - status [ref=e130]:
            - generic [ref=e131]: Active
        - heading "Brand/logo separated into a dedicated Figma library file (amends ADR-080)" [level=1] [ref=e132]
        - generic [ref=e133]:
          - generic [ref=e134]:
            - term [ref=e135]: Date
            - definition [ref=e136]: 2026-07-21
          - generic [ref=e137]:
            - term [ref=e138]: Decision makers
            - definition [ref=e139]: Guilherme Negreiros — Design System Lead
      - heading "Context" [level=2] [ref=e140]
      - paragraph [ref=e141]:
        ...
        - code [ref=e142]: FOUNDATIONS > logos
      ...
      - paragraph [ref=e143]: "This has now been executed, not just discussed:"
      - list [ref=e144]:
        - listitem [ref=e145]:
          - text: The
          - code [ref=e146]: ↳ logos
          ...
          - code [ref=e148]: Symbole
          - text: ", 5 color"
      - paragraph [ref=e149]:
        - text: variants — the same content ADR-080 described under
        - code [ref=e150]: FOUNDATIONS > logos
        - text: ) has been moved out of the main design system file into a new dedicated file,
        - strong [ref=e151]:
          - code [ref=e152]: Agentica | Brand
        - text: (file key
        - code [ref=e153]: F8jhyCeRJaJhF7W1inlFuc
        - text: ), confirmed live via the Figma MCP connector.
      - list [ref=e154]:
        - listitem [ref=e155]: The move is permanent, with no back-reference left in the main file.
        - listitem [ref=e156]:
          - code [ref=e157]: Agentica | Brand
          - text: has been published as a Figma library and is consumed by the
      - paragraph [ref=e158]:
        - text: main file (
        - code [ref=e159]: Agentica — Agentic design system
        - text: ", file key"
        - code [ref=e160]: uXgPVB6cMLwAPqSwoa0dGq
      ...
      - paragraph [ref=e164]: change.
      - heading "Decision" [level=2] [ref=e165]
      - paragraph [ref=e166]:
        - strong [ref=e167]: "Amends ADR-080 Rule 1:"
        - code [ref=e168]: FOUNDATIONS > logos
      ...
      - paragraph [ref=e170]:
        - strong [ref=e171]: ADR-080 Rule 2 (pre-publication nested-instance audit) is reaffirmed and now concretely in scope
        - text: ", not merely a future contingency: because"
        - code [ref=e172]: Agentica | Brand
      ...
      - paragraph [ref=e174]:
        - code [ref=e175]: tokens/figma-text-styles.json
      ...
      - heading "Rejected alternatives" [level=2] [ref=e176]
      - paragraph [ref=e177]: "See ADR-080's \"Discussion en cours\" section for the alternative actually considered at the time (keep the logo page in the main file, rely solely on the Rule 1 page-exclusion list at each publish) — rejected there already, for the reasons recorded in that ADR: a manually-excluded page is one more thing to remember at every future publish, where a structural file boundary removes the need to remember it at all for the page-level case."
      - heading "Consequences" [level=2] [ref=e178]
      - list [ref=e179]:
        - listitem [ref=e180]:
          - code [ref=e181]: .claude/rules/figma-library-governance.md
          - text: "'s Community File content triage section"
      - paragraph [ref=e182]:
        - text: (added under ADR-080) is updated to drop
        - code [ref=e183]: FOUNDATIONS > logos
        - text: from the exclusion table and record the new
        - code [ref=e184]: Agentica | Brand
        - text: file key alongside the main file's.
      - list [ref=e185]:
        - listitem [ref=e186]: "The GitHub Projects \"Séparer les composants Brand/logo dans un fichier Figma dédié\" ticket (P2) moves to Terminé (the board's Status field is French: Backlog/En cours/Terminé/etc.)."
        - listitem [ref=e187]: Before the Community File is ever actually published, ADR-080's Rule 2 audit must
      - paragraph [ref=e188]: still be run in full against whatever components/patterns exist by then — this ADR does not shrink that audit's scope, only the Rule 1 page list.
      - list [ref=e189]:
        - listitem [ref=e190]: "Separately (not part of this decision, flagged for follow-up): while verifying this"
      - paragraph [ref=e191]:
        - text: change,
        - code [ref=e192]: get_metadata
        - text: without a
        - code [ref=e193]: nodeId
      ...
      - generic [ref=e194]:
        - link "← ADR-081" [ref=e195] [cursor=pointer]:
          - /url: adr-081.html
        - link "ADR-083 →" [ref=e196] [cursor=pointer]:
          - /url: adr-083.html
    - navigation "Table of contents / Table des matières" [ref=e197]:
      - generic [ref=e198]: On this page
      - link "Context" [ref=e199] [cursor=pointer]:
        - /url: "#context"
      - link "Decision" [ref=e200] [cursor=pointer]:
        - /url: "#decision"
      - link "Rejected alternatives" [ref=e201] [cursor=pointer]:
        - /url: "#rejected-alternatives"
      - link "Consequences" [ref=e202] [cursor=pointer]:
        - /url: "#consequences"
  - contentinfo [ref=e203]:
    - generic [ref=e204]:
      - generic [ref=e205]:
        - link "Agentica — Accueil" [ref=e206] [cursor=pointer]:
          - /url: ../index.html
          - img [ref=e207]
        - link "Guilherme Negreiros" [ref=e208] [cursor=pointer]:
          - /url: https://www.linkedin.com/in/gnegreiros/
          - img [ref=e209]
          - text: Guilherme Negreiros
      - generic [ref=e213]:
        - generic [ref=e214]: Navigation
        - link "Home" [ref=e215] [cursor=pointer]:
          - /url: ../index.html
        - link "Why" [ref=e216] [cursor=pointer]:
          - /url: ../pourquoi.html
        - link "Architecture" [ref=e217] [cursor=pointer]:
          - /url: ../architecture.html
        - link "Quality" [ref=e218] [cursor=pointer]:
          - /url: ../qualite.html
        - link "AI" [ref=e219] [cursor=pointer]:
          - /url: ../ia.html
      - generic [ref=e220]:
        - generic [ref=e221]: Documentation
        - link "Understand" [ref=e222] [cursor=pointer]:
          - /url: ../pourquoi.html
        - link "Get started" [ref=e223] [cursor=pointer]:
          - /url: ../get-started.html
        - link "Foundations" [ref=e224] [cursor=pointer]:
          - /url: ../foundations/index.html
        - link "Components" [ref=e225] [cursor=pointer]:
          - /url: ../components/index.html
        - link "Tokens" [ref=e226] [cursor=pointer]:
          - /url: ../tokens/index.html
        - link "Decisions" [ref=e227] [cursor=pointer]:
          - /url: ../decisions/index.html
        - link "Continuity" [ref=e228] [cursor=pointer]:
          - /url: ../continuite.html
        - link "Changelog" [ref=e229] [cursor=pointer]:
          - /url: ../changelog.html
      - generic [ref=e230]:
        - generic [ref=e231]: Explorer
        - link "Storybook" [ref=e232] [cursor=pointer]:
          - /url: https://main--6a1c1e665ec5fe8fc0540983.chromatic.com/
        - link "GitHub" [ref=e233] [cursor=pointer]:
          - /url: https://github.com/gnegreiros-ux/agentica-design-system
        - link "Audit" [ref=e234] [cursor=pointer]:
          - /url: ../audit.html
        - link "AI Brief" [ref=e235] [cursor=pointer]:
          - /url: ../ai-brief.html
    - generic [ref=e236]:
      - generic [ref=e237]: © 2026 Guilherme Negreiros
      - generic [ref=e238]: Built with Claude Code.
  - button "Retour en haut" [ref=e239] [cursor=pointer]:
    - img [ref=e240]
    - generic [ref=e242]: Top
  - status [ref=e243]
```
